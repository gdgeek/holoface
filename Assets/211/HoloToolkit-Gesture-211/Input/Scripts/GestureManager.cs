...
namespace Academy.HoloToolkit.Unity
{
    public class GestureManager : Singleton<GestureManager>
    {
        ...
        private void NavigationRecognizer_NavigationStartedEvent(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            ...
            if (focusedGameObject_ == null && HandsManager.Instance.FocusedGameObject != null)
            {
                focusedGameObject_ = HandsManager.Instance.FocusedGameObject;
                focusedGameObject_.SendMessageUpwards("PerformNavigationStart", relativePosition);
            }
        ...
        public GameObject focusedGameObject_ = null;
        private void NavigationRecognizer_NavigationUpdatedEvent(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            ...
            if (focusedGameObject_ != null )
            {
                focusedGameObject_.SendMessageUpwards("PerformNavigationUpdate", relativePosition);
            }
        ...
        private void NavigationRecognizer_NavigationCompletedEvent(InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            ...
            if (focusedGameObject_ != null)
            {
                focusedGameObject_.SendMessageUpwards("PerformNavigationRelease");
                focusedGameObject_ = null;
            }
